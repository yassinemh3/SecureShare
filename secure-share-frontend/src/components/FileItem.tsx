...
const FileItem: React.FC<FileItemProps> = ({ file, onDownload, onDelete, onShare }) => {
  ...
  return (
     <div className="flex flex-col gap-2">
      <div className="flex-1 flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-muted rounded-md border hover:shadow-sm transition">
          ...
          <div className="flex flex-wrap gap-2 justify-end">
            ...
            {file.content && (
              <Button
                ...
                className={showSummary ? "bg-accent" : ""}
              >
        ...
        {/* Summary panel that appears below when toggled */}
